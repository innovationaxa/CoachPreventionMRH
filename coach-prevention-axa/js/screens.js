...
function screenLockNotif() {
  ...
  return `
    <div style="background:radial-gradient(ellipse at 60% 0%,#3b2d6e 0%,#1a1040 35%,#0d0820 65%,#080410 100%);min-height:100%;display:flex;flex-direction:column;position:relative;overflow:hidden;user-select:none">
      ...
      <!-- Heure + date centrés -->
      <div style="text-align:center;padding:36px 20px 0">
      ...
      <div style="padding:28px 18px 0;flex:1">
        <div onclick="launchFromNotif()"
          ...
          <div style="font-size:12px;color:rgba(255,255,255,.62);line-height:1.45;font-family:var(--font)">${notif.body}</div>

          <!-- Indicateur d'action -->
          <div style="margin-top:11px;padding-top:10px;border-top:1px solid rgba(255,255,255,.1);display:flex;align-items:center;justify-content:center;gap:6px">
            <div style="font-size:11px;color:rgba(255,255,255,.38);font-family:var(--font)">Appuyez pour ouvrir votre Coach</div>
          </div>
        </div>
      </div>
