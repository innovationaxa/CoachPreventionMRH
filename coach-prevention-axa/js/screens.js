...
function screenRewards() {
  ...
  return `<div class="screen-header" style="background:linear-gradient(135deg,var(--axa) 0%,#1a1466 100%);padding:18px var(--sp5) 20px;color:white">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:6px">
      <div style="background:rgba(255,255,255,.12);border-radius:10px;padding:10px 8px;text-align:center">
        <div style="font-size:24px;font-weight:800">${actionCount}</div>
        <div style="font-size:9px;opacity:.65;margin-top:1px">actions</div>
      </div>
      <div style="background:rgba(255,255,255,.12);border-radius:10px;padding:10px 8px;text-align:center">
        <div style="font-size:24px;font-weight:800">${badgeCount}</div>
        <div style="font-size:9px;opacity:.65;margin-top:1px">badges</div>
      </div>
      <div style="background:rgba(255,255,255,.12);border-radius:10px;padding:10px 8px;text-align:center">
        <div style="font-size:24px;font-weight:800">${annualScore}%</div>
  ...
  <div style="padding:16px var(--sp5);display:flex;flex-direction:column;gap:18px">
    ...
    <div>
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px">
        <div>
          <div style="font-size:13px;font-weight:700;color:var(--n900)">🏅 Mes Achievements</div>
